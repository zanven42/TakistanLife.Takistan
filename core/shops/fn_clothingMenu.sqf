...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","barber"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if((_this select 3) == "reb" && !license_civ_rebel) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
if((_this select 3) in ["cop","nato"] && playerSide != west) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
